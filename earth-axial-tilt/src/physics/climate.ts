...
export function annualMeanInsolation(latitudeDeg: number, obliquityDeg: number, orbit?: OrbitParameters): number {
...
export function annualProfile(latitudeDeg: number, obliquityDeg: number, orbit?: OrbitParameters): AnnualPoint[] {
