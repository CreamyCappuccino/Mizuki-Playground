import { effectiveHeatDepth, isIdealizedGeography, type ClimateProfile } from '../physics/climateGeography';
...
export function renderClimateStatus(snapshot: ClimateStatusSnapshot): void {
    ...
    const effectiveDepth = effectiveHeatDepth(profile, classicDepth);
    ...
    document.querySelector<HTMLElement>('#temperature-model-note')!.textContent = thermal
