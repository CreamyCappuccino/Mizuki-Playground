...
Coupled motion advances one mean-model clock. At ×1 a day takes ten seconds; ×4/×12 preserve the spin/orbit ratio. The 365-mean-solar-day circular model has 366 inertial turns. Play day and Play year retain their old, intentionally independent meanings. Use Play year for a rapid survey of seasons.
...
The atlas shows latitude across a model year. Its difference layer always compares the displayed world A with 23.44°, **not B**, even when Compare Lab is active. Click/tap to choose date and latitude; vertical swipes scroll. The dashed curve is the subsolar latitude, not the warmest point.
